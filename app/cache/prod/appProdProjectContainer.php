...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfonyblog', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Pello/CustomerCrudBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Pello/FormsBundle/Entity'), 2 => ($this->targetDirs[3].'/src/Samples/BlogBundle/Entity')));
        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Pello\\CustomerCrudBundle\\Entity');
        $c->addDriver($b, 'Pello\\FormsBundle\\Entity');
        $c->addDriver($b, 'Samples\\BlogBundle\\Entity');
        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('PelloCustomerCrudBundle' => 'Pello\\CustomerCrudBundle\\Entity', 'PelloFormsBundle' => 'Pello\\FormsBundle\\Entity', 'SamplesBlogBundle' => 'Samples\\BlogBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ad9871642a27ccc4467dd1bb5415246803d08efd11854952b278f283b8815e2d');
        return $instance;
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Samples\\BlogBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha1', 1 => false, 2 => 1))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/blog/login');
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/blog/*');
        ...
        $k = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $j, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($j, '/blog/login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        ...
        $l->setOptions(array('login_path' => '/blog/login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $m->setOptions(array('login_path' => '/blog/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($i, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.user_db')), 'secured_area', $a, $c), 2 => $k, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $j, 'secured_area', $l, $m, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5529a7ad0066b', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $i, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $j, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $j, '/blog/login', false), NULL, NULL, $a));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Pello/CustomerCrudBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Pello/FormsBundle/Resources/translations/messages.en.xlf'), 'en', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Pello/FormsBundle/Resources/translations/validators.en.xlf'), 'en', 'validators');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Pello/FormsBundle/Resources/translations/validators.es.xlf'), 'es', 'validators');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Pello/FormsBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Pello/FormsBundle/Resources/translations/messages.es.xlf'), 'es', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Samples/BlogBundle/Resources/translations/messages.en.xlf'), 'en', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Samples/BlogBundle/Resources/translations/validators.en.xlf'), 'en', 'validators');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Samples/BlogBundle/Resources/translations/validators.es.xlf'), 'es', 'validators');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Samples/BlogBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Samples/BlogBundle/Resources/translations/messages.es.xlf'), 'es', 'messages');
        return $instance;
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Pello/CustomerCrudBundle/Resources/views'), 'PelloCustomerCrud');
        $instance->addPath(($this->targetDirs[3].'/src/Pello/FormsBundle/Resources/views'), 'PelloForms');
        $instance->addPath(($this->targetDirs[3].'/src/Samples/BlogBundle/Resources/views'), 'SamplesBlog');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => ($this->targetDirs[3].'/src/Pello/CustomerCrudBundle/Resources/config/validation.yml'), 1 => ($this->targetDirs[3].'/src/Pello/FormsBundle/Resources/config/validation.yml'), 2 => ($this->targetDirs[3].'/src/Samples/BlogBundle/Resources/config/validation.yml')));
    ...
    {
        return $this->services['security.user.provider.concrete.user_db'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Samples\\BlogBundle\\Entity\\User', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PelloCustomerCrudBundle' => 'Pello\\CustomerCrudBundle\\PelloCustomerCrudBundle',
                'PelloFormsBundle' => 'Pello\\FormsBundle\\PelloFormsBundle',
                'SamplesBlogBundle' => 'Samples\\BlogBundle\\SamplesBlogBundle',
            ),
